...
const showGraph = (showRate, position) => {
    ...
    context.fillRect(
        (position + 1) * barLength + shift - 0.5,
        284.5,
        barLength * Math.min(GRAPH_LENGTH + 1, showRate.length),
        17
    );
